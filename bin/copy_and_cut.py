...
if os.path.exists(os.path.join(base, ima, 'epi_masked_full_.nii.gz')):
    ...
    shutil.copy(os.path.join(base, ima, 'epi_masked.nii.gz'), os.path.join(base, ima, 'epi_masked_full.nii.gz'))
...
print('img at', os.path.join(base, ima, 'epi_masked.nii.gz'), ' now has dim ', new.shape, ' meaning ', new.shape[-1], ' time points')
